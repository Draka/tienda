...
System.register("libs/session", ["libs/get_api"], function (exports_4, context_4) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            Session = /** @class */ (function () {
                ...
                Session.product = function (product, xclass) {
                    var _a;
                    if (!product) {
                        return "<div class=\"col " + xclass + "\"></div>";
                    }
                    var html = "<div class=\"col " + xclass + "\"><div class=\"h-100 white-sm white-md white-lg white-xl p-1-sm p-1-md p-1-lg p-1-xl sh-hover-sm sh-hover-md sh-hover-lg sh-hover-xl rd-0-2 oh\">"
                        + '<div class="h-100 relative mb-0-5">'
                        + ("<a class=\"mb-1\" href=\"/tiendas/" + product.storeID.slug + "/productos/" + product.slug + "\">")
                        ...
                        + '</div>';
                    if (((_a = product === null || product === void 0 ? void 0 : product.offer) === null || _a === void 0 ? void 0 : _a.percentage)
                        ...
                        html += "<div class=\"b t-primary\">$" + product.offer.price + " <span class=\"very-small\">(Precio Final)</span></div>"
                            + ("<div class=\"b t t-gray-2-500 mb-4\">$" + product.price + " <span class=\"very-small\">(Precio original)</span></div>")
                    ...
                    html += "<a class=\"btn btn--primary mt-0-25 small ph-0-25 rd-50 w-100 absolute ab-0\" href=\"/tiendas/" + product.storeID.slug + "/productos/" + product.slug + "\">\u00A1Lo quiero!</a>"
                        + '</div>'
                        + '</div>'
                        + '</div></div>';
                    return html;
            ...
            Product = /** @class */ (function () {
                ...
                Product.single = function (product, pos, list) {
                    ...
                    productHTML.html("" + ("<div class=\"h-100 relative p-3 pb-7 product\" data-sku=\"" + product.sku + "\">"
                        + ("<a href=\"/tiendas/" + vars_2.Vars.store + "/productos/" + product.slug + "\">" + Product.img(product) + "</a>")) + (product.brandText ? "<div class=\"t-white-700 small mb-1\">" + product.brandText + "</div>" : '') + "<div class=\"t-primary tc b small\">" + product.name + "</div>"
...
System.register("libs/cart_list", ["libs/cart", "libs/product", "libs/vars", "libs/get_api", "libs/session", "libs/gtag", "libs/show_msg"], function (exports_9, context_9) {
    "use strict";
    var cart_2, product_1, vars_3, get_api_3, session_2, gtag_3, show_msg_1, CartList;
...
System.register("libs/cart", ["libs/vars", "libs/get_api", "libs/gtag", "libs/cart_count", "libs/show_msg", "libs/product", "libs/cart_list"], function (exports_10, context_10) {
    "use strict";
    var vars_4, get_api_4, gtag_4, cart_count_1, show_msg_2, product_2, cart_list_1, Cart;
    ...
    return {
        setters: [
            ...
            function (get_api_4_1) {
                get_api_4 = get_api_4_1;
            },
            function (gtag_4_1) {
                gtag_4 = gtag_4_1;
            },
        ...
        execute: function () {/* eslint-disable no-mixed-operators */
            ...
            Cart = /** @class */ (function () {
                function Cart() {
                    this.getApi = new get_api_4.GetApi();
